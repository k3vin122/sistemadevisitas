...
class PermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Permission::create(['name' => 'list proveedors']);
        Permission::create(['name' => 'view proveedors']);
        Permission::create(['name' => 'create proveedors']);
        Permission::create(['name' => 'update proveedors']);
        Permission::create(['name' => 'delete proveedors']);

        Permission::create(['name' => 'list registros']);
        Permission::create(['name' => 'view registros']);
